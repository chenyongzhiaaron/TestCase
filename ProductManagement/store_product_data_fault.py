...
class StoreProductData(unittest.TestCase):
    ...
    @parameterized.expand([
        ("product_pramas_null", "", "", "", "", "", "", 422000, "illegal.request.data", ['required'], ['required'],
         ['integer'], ['required']),
    ])
    def test_store_product_data(self, case_name, type, name, model, color, hs_code, description, status, message,
                                result_error_01, result_error_02, result_error_03, result_error_04):
