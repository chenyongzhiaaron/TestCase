...
class UpdateProductDdataSuccess(unittest.TestCase):
    ...
    def setUp(self):
        self.url = global_base.BaseUrl.url(self, "/products/768")
    ...
    @parameterized.expand([
        ("更新产品成功", "2000", "productname", "model", 14000, "hs_code", "description", 0, "success", 768, 2000, "productname", "model", 14000, "hs_code", "description", ),
    ])
